...
typedef struct lru_stack_t {
    ...
    int* arr;
    //note: MRU will be stored at 0, and LRU will be stored at length
    /*
    struct idx_stack_item* mru; //essentially the head
    struct idx_stack_item* lru; //essentially the tail
    */
} lru_stack_t;
